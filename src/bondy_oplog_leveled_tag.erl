...
application:set_env(leveled, extract_metadata,
    fun bondy_oplog_leveled_tag:extract_metadata/3),
application:set_env(leveled, build_head,
    fun bondy_oplog_leveled_tag:build_head/2),
```
...
final shape `bondy_oplog_projection_leveled:head/3` hands back to the
substrate.
""".
-spec build_head(
    Tag :: atom(),
