...
The leveled tag's metadata extractor (`bondy_oplog_leveled_tag`)
...
(HasValueColumn=0). See `bondy_oplog_leveled_tag:extract_metadata/3`.
""").
...
leveled extractor `bondy_oplog_leveled_tag:extract_metadata/3`) into
`{Hlc, ValueBytes}`.
