%% =============================================================================
%% PropEr properties for `bondy_oplog_fold_g_counter`.
%%
...
-module(bondy_oplog_fold_g_counter_proper_test).
...
%% G-Counter only accepts non-negative deltas.
delta_gen() ->
    integer(0, 100).
...
%% state. A `none` delta means the value did not change.
