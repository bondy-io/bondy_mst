...
registry_defaults_tier_0() ->
    ...
    ?assertEqual(tier_0, bondy_db_core_registry:entry_causal_tier(Entry)),
...
registry_records_tier_2() ->
    ...
    {ok, Entry} = bondy_db_core_registry:lookup(NS, primary, 0),
    ?assertEqual(tier_2, bondy_db_core_registry:entry_causal_tier(Entry)),
    teardown_shard(NS, C, P).
...
register_shard(NS, Extra) ->
    ...
    ok = bondy_db_core_registry:register(NS, primary, 0, Config),
    {C, P}.
