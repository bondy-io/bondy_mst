...
cleanup(_) ->
    ...
    ok = bondy_oplog_sync_scheduler:set_bootstrap_retry_base_ms(500),
    ok = bondy_oplog_sync_scheduler:set_bootstrap_retry_max_ms(30000),
    ok = bondy_oplog_sync_scheduler:set_bootstrap_retry_jitter(true),
...
backoff_deferred_telemetry_fires() ->
    ...
    %% the test.
    ok = bondy_oplog_sync_scheduler:set_bootstrap_retry_base_ms(60000),
    ok = bondy_oplog_sync_scheduler:set_bootstrap_retry_max_ms(60000),
...
setters_take_effect_on_next_failure() ->
    Inst = mk_id(),
    ets:delete(?BACKOFF_TAB, Inst),
    ok = bondy_oplog_sync_scheduler:set_bootstrap_retry_base_ms(50),
    ...
    ets:delete(?BACKOFF_TAB, Inst),
    ok = bondy_oplog_sync_scheduler:set_bootstrap_retry_base_ms(800),
