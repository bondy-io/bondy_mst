...
aw_map_e2e_test_() ->
    {foreach, fun setup/0, fun cleanup/1, [
        test(
            "put_apply_read_round_trip",
            fun put_apply_read_round_trip/1
        ),
        test(
            "remove_aw_key_resolves_and_removes",
            fun remove_aw_key_resolves_and_removes/1
        ),
        test(
            "remove_aw_key_on_absent_key_is_passthrough",
            fun remove_aw_key_on_absent_key_is_passthrough/1
        ),
        test(
            "remove_aw_key_on_tombstoned_key_is_idempotent",
