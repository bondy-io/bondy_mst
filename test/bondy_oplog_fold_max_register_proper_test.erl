%% =============================================================================
%% PropEr properties for `bondy_oplog_fold_max_register`.
%%
%% Validates the patterns in `_design/catalogue_expansion_plan.md` §4.5.
%% =============================================================================

-module(bondy_oplog_fold_max_register_proper_test).
...
meta_gen() ->
    ?LET({H, O, S}, {hlc_gen(), origin_gen(), integer(0, 100)},
...
prop_apply_event_idempotent() ->
    ?FORALL({State, Meta, Event}, {state_gen(), meta_gen(), event_gen()},
        begin
